...
func NewSession(domainController string, domain string, username string, password string, useLDAPS bool, debug bool) (Discoverer, error) {
    ...
    return newSessionImpl(domainController, domain, username, password, useLDAPS, debug)
}
